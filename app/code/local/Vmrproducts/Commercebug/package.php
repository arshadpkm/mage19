...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Vmrproducts_Commercebug><active>true</active><codePool>local</codePool></Vmrproducts_Commercebug></modules></config>';
        $string = str_replace('Vmrproducts_', $this->namespace . '_',$string);
