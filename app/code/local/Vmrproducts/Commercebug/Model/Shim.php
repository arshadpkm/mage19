...
*/
class Vmrproducts_Commercebug_Model_Shim
{
    ...
    */    
    ...
    protected function _getNamespaceForGroup($group)
    {
        ...
        {
            case 'commercebug':
                $module = 'Vmrproducts_Commercebug';
    ...
    {
        $full_module_name = 'Vmrproducts_Commercebug';
    ...
    static public function getInstance()
    {
        if(!self::$_instance)
        {
            self::$_instance = new Vmrproducts_Commercebug_Model_Shim;
        }
