...
*/
class Vmrproducts_Commercebug_Model_Collectorblocksandlayout extends Vmrproducts_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Vmrproducts_Commercebug') === 0)
            {
                continue;
            }
