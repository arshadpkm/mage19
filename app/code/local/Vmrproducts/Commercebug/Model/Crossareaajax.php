...
*/
abstract class Vmrproducts_Commercebug_Model_Crossareaajax
{
    ...
    */    
    ...
    {
        $controllers = array('Vmrproducts_Commercebug_AjaxController','Vmrproducts_Commercebug_AdminajaxController');
        ...
        foreach($controllers as $controller)
        {
            ...
            'Vmrproducts_Commercebug_Model_Crossareaajax','appendAction'), self::$_actionNames);
